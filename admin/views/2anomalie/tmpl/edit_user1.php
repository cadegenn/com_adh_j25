...
<form action="<?php echo JRoute::_('index.php?option=com_adh&layout=edit&id='.(int) $this->form1->getField('id')->value.'&user1id='.(int) $this->form1->getField('id')->value.'&user2id='.(int) $this->form2->getField('id')->value); ?>"
	...
	<div class='width-50 fltlft'>
		...
		<fieldset class="adminform">
			<legend><?php echo JText::_( 'COM_ADH_ADHERENT_DETAILS' ); ?> <small>(<?php echo (int) $this->form1->getField('id')->value; ?>)</small></legend>
			<div class="tr">
		...
		<?php echo JHtml::_('sliders.start', 'content-sliders-'.(int) $this->form1->getField('id')->value, array('useCookie'=>1)); ?>
			<?php echo JHtml::_('sliders.panel', JText::_('COM_ADH_FIELDSET_PUBLISHING'), 'meta-options'); ?>
				<fieldset class="panelform">
					<ul class="adminformlist">
						<li><?php echo $this->form1->getLabel('creation_date'); ?>
						<?php echo $this->form1->getInput('creation_date'); ?></li>
						
						<li><?php echo $this->form1->getLabel('published'); ?>
						<?php echo $this->form1->getInput('published'); ?></li>
						
						<li><?php echo $this->form1->getLabel('modified_by'); ?>
						<?php echo $this->form1->getInput('modified_by'); ?></li>
						
						<li><?php echo $this->form1->getLabel('modification_date'); ?>
						<?php echo $this->form1->getInput('modification_date'); ?></li>
					</ul>
				</fieldset>
		...
		<?php echo JHtml::_('sliders.start', 'content-sliders-'.(int) $this->form1->getField('id')->value, array('useCookie'=>1)); ?>
			<?php echo JHtml::_('sliders.panel', JText::_('COM_ADH_OPTIONS'), 'meta-options'); ?>
				<fieldset class="panelform">
					<ul class="adminformlist">
						<li><?php echo $this->form1->getLabel('imposable'); ?>
						<?php echo $this->form1->getInput('imposable'); ?></li>
						
						<li><?php echo $this->form1->getLabel('recv_newsletter'); ?>
						<?php echo $this->form1->getInput('recv_newsletter'); ?></li>
						
						<li><?php echo $this->form1->getLabel('recv_infos'); ?>
						<?php echo $this->form1->getInput('recv_infos'); ?></li>
					</ul>
				</fieldset>
		<?php echo JHtml::_('sliders.end'); ?>
		...
		<?php echo JHtml::_('sliders.start', 'content-sliders-'.(int) $this->form1->getField('id')->value, array('useCookie'=>1)); ?>
			<?php echo JHtml::_('sliders.panel', JText::_('COM_ADH_FIELDSET_COTISATIONS'), 'meta-options'); ?>
				<fieldset class="panelform">
					<label><a href='<?php echo JRoute::_('index.php?option=com_adh&view=cotisation&layout=edit&id=0&adherent_id='.$this->form1->getField("id")->value); ?>'><?php echo JText::_('COM_ADH_FIELDSET_COTISATIONS_NEW'); ?></a></label>
					<!--<ul class="adminformlist">-->
						<?php 
							if ((int) $this->form1->getField('id')->value != 0) : 
								$db = JFactory::getDbo();
								...
								$query->where('adherent_id = "'.$this->form1->getField("id")->value.'"');
        ...
        <?php JFactory::getApplication()->setUserState('com_adh.edit.1anomalie.user1.id', (int) $this->form1->getField('id')->value); ?>
		<?php echo JHtml::_('form.token'); ?>
		
		<pre><?php var_dump($bar1); ?></pre>
		<?php $session = JFactory::getSession();
		$registry = $session->get('registry');?>
		<pre><?php var_dump($registry->get('com_adh.edit.1anomalie.user1.id')); ?></pre>
	</div>
</form>
