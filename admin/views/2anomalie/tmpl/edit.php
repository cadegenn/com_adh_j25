...
<form action="<?php echo JRoute::_('index.php?option=com_adh&layout=edit'); ?>"
	...
	<div>
		<input type="hidden" name="task" value="2anomalie.edit" />
        <?php //JFactory::getApplication()->setUserState('com_adh.edit.2anomalie.id.user1', (int) $this->form1->getField('id')->value); ?>
